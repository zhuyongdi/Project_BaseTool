package com.zhuyongdi.app.decoration.divider;
...
public class ZYDColorDivider implements ZYDIDivider {
    ...
    public ZYDColorDivider() {
        this(DEFAULT_COLOR, DEFAULT_SIZE);
    }

    public ZYDColorDivider(@ColorInt int color) {
        this(color, DEFAULT_SIZE);
    }

    public ZYDColorDivider(@ColorInt int color, int size) {
        mColor = color;
        mSize = size;
