...
public class ChinaAreaString {
     ...
     * 广西
     */
    public static final String GOANG_XI = "广西";
    ...
    public static final List<String> AREA_LIST = Arrays.asList(BEI_JING, TIAN_JIN, HE_BEI, SHAN_XI, NEI_MENG_GU, LIAO_NING, JI_LIN, HEI_LONG_JIANG, SHANG_HAI, JIANG_SU, ZHE_JIANG, AN_HUI, FU_JIAN, JIANG_XI, SHAN_DONG, HE_NAN, HU_BEI, HU_NAN, GUANG_DONG, GOANG_XI, HAI_NAN, CHONG_QING, SI_CHUANG, GUI_ZHOU, YUN_NAN, XI_ZANG, SAN_XI, GAN_SU, QING_HAI, NING_XIA, XIN_JIANG, TAI_WAN, XIANG_GANG, AO_MEN, GUO_WAI);
