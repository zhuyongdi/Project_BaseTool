 ...
 * @since 19 Mar 2016
 */
@CoordinatorLayout.DefaultBehavior(XXBottomVerticalScrollBehavior.class)
public class XXBottomNavigationBar extends FrameLayout {
     ...
     * item 数据列表
     */
    ArrayList<XXBottomNavigationItem> mBottomNavigationItems = new ArrayList<>();
    /**
     * 存储tab的列表
     */
    ArrayList<XXBottomNavigationTab> mBottomNavigationTabs = new ArrayList<>();
    ...
    public XXBottomNavigationBar(Context context) {
        this(context, null);
    }

    public XXBottomNavigationBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXBottomNavigationBar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public XXBottomNavigationBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            TypedArray typedArray = context.getTheme().obtainStyledAttributes(attrs, R.styleable.XXBottomNavigationBar, 0, 0);

            mActiveColor = typedArray.getColor(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_active_color, ContextCompat.getColor(context, R.color.xx_text_color));
            mInActiveColor = typedArray.getColor(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_inactive_color, Color.LTGRAY);
            mBackgroundColor = typedArray.getColor(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_background_color, Color.WHITE);
            mAutoHideEnabled = typedArray.getBoolean(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_auto_hide_enabled, true);
            mElevation = typedArray.getDimension(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_elevation, getResources().getDimension(R.dimen.xx_bottom_navigation_elevation));

            setAnimationDuration(typedArray.getInt(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_animation_duration, DEFAULT_ANIMATION_DURATION));

            switch (typedArray.getInt(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_mode, MODE_DEFAULT)) {
                case MODE_FIXED:
                    mMode = MODE_FIXED;
                    break;
            ...
            switch (typedArray.getInt(R.styleable.XXBottomNavigationBar_xx_bottom_navigation_bard_bnb_background_style, BACKGROUND_STYLE_DEFAULT)) {
            ...
            mActiveColor = ContextCompat.getColor(context, R.color.xx_text_color);
            mInActiveColor = Color.LTGRAY;
            mBackgroundColor = Color.WHITE;
            mElevation = getResources().getDimension(R.dimen.xx_bottom_navigation_elevation);
        }
    }
    ...
    private void init() {
        ...
        View parentView = inflater.inflate(R.layout.xx_bottom_navigation_bar_container, this, true);
...
//    }
     ...
     */
    public XXBottomNavigationBar addItem(XXBottomNavigationItem item) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar removeItem(XXBottomNavigationItem item) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setMode(@Mode int mode) {
        this.mMode = mode;
        return this;
    }
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setBackgroundStyle(@BackgroundStyle int backgroundStyle) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setActiveColor(@ColorRes int activeColor) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setActiveColor(String activeColorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setInActiveColor(@ColorRes int inActiveColor) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setInActiveColor(String inActiveColorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setBarBackgroundColor(@ColorRes int backgroundColor) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setBarBackgroundColor(String backgroundColorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setFirstSelectedPosition(int firstSelectedPosition) {
     ...
     */
    private XXBottomNavigationBar setScrollable(boolean scrollable) {
    ...
    public void initialise() {
        ...
        if (!mBottomNavigationItems.isEmpty()) {
            ...
            int screenWidth = XXScreenUtil.getScreenWidth(getContext());

            if (mMode == MODE_FIXED || mMode == MODE_FIXED_NO_TITLE) {

                //获得tab的宽度
                int[] widths = XXBottomNavigationHelper.getMeasurementsForFixedMode(getContext(), screenWidth,
                        mBottomNavigationItems.size(), mScrollable);
                int itemWidth = widths[0];

                for (XXBottomNavigationItem currentItem : mBottomNavigationItems) {
                    XXFixedBottomNavigationTab bottomNavigationTab = new XXFixedBottomNavigationTab(getContext());
                ...
                int[] widths = XXBottomNavigationHelper.getMeasurementsForShiftingMode(getContext(), screenWidth, mBottomNavigationItems.size(), mScrollable);

                int itemWidth = widths[0];
                int itemActiveWidth = widths[1];

                for (XXBottomNavigationItem currentItem : mBottomNavigationItems) {
                    XXShiftingBottomNavigationTab bottomNavigationTab = new XXShiftingBottomNavigationTab(getContext());
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setTabSelectedListener(OnTabSelectedListener tabSelectedListener) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationBar setAnimationDuration(int animationDuration) {
     ...
     */
    private void setUpTab(boolean isNoTitleMode, XXBottomNavigationTab bottomNavigationTab,
                          XXBottomNavigationItem currentItem, int itemWidth, int itemActiveWidth) {
        ...
        bottomNavigationTab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                XXBottomNavigationTab bottomNavigationTabView = (XXBottomNavigationTab) v;
        ...
        XXBottomNavigationHelper.bindTabWithData(currentItem, bottomNavigationTab, this);
    ...
    private void selectTabInternal(int newPosition, boolean firstTab, boolean callListener, boolean forcedSelection) {
        ...
        if (mSelectedPosition != newPosition) {
            if (mBackgroundStyle == BACKGROUND_STYLE_STATIC) {
                ...
                final XXBottomNavigationTab clickedView = mBottomNavigationTabs.get(newPosition);
                if (firstTab) {
                    // 第一次初始化不显示水波纹效果
...
//                            try {
                            //设置背景水波纹效果
                            XXBottomNavigationHelper.setBackgroundWithRipple(clickedView, mContainer, mBackgroundOverlay,
...
//                && oldPosition != -1) {
    ...
    public void setFab(FloatingActionButton fab) {
        ...
        if (layoutParams != null && layoutParams instanceof CoordinatorLayout.LayoutParams) {
            ...
            XXBottomNavBarFabBehaviour bottomNavBarFabBehaviour = new XXBottomNavBarFabBehaviour();
