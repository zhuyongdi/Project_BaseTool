 ...
 * @since 19 Mar 2016
 */
class XXBottomNavigationHelper {

    private XXBottomNavigationHelper() {
    }
    ...
    static int[] getMeasurementsForFixedMode(Context context, int screenWidth, int noOfTabs, boolean scrollable) {
        ...
        int minWidth = (int) context.getResources().getDimension(R.dimen.xx_fixed_min_width_small_views);
        int maxWidth = (int) context.getResources().getDimension(R.dimen.xx_fixed_min_width);

        int itemWidth = screenWidth / noOfTabs;

        if (itemWidth < minWidth && scrollable) {
            itemWidth = (int) context.getResources().getDimension(R.dimen.xx_fixed_min_width);
    ...
    static int[] getMeasurementsForShiftingMode(Context context, int screenWidth, int noOfTabs, boolean scrollable) {
        ...
        int minWidth = (int) context.getResources().getDimension(R.dimen.xx_shifting_min_width_inactive);
        int maxWidth = (int) context.getResources().getDimension(R.dimen.xx_shifting_max_width_inactive);
     ...
     */
    static void bindTabWithData(XXBottomNavigationItem bottomNavigationItem, XXBottomNavigationTab bottomNavigationTab, XXBottomNavigationBar bottomNavigationBar) {
        ...
        XXBadgeItem badgeItem = bottomNavigationItem.getBadgeItem();
        if (badgeItem != null) {
