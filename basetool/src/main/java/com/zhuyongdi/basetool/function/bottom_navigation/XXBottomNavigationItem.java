 ...
 * @since 19 Mar 2016
 */
public class XXBottomNavigationItem {
    ...
    private XXBadgeItem mBadgeItem;

    /**
     * @param mIconResource resource for the Tab icon.
     * @param mTitle        title for the Tab.
     */
    public XXBottomNavigationItem(@DrawableRes int mIconResource, @NonNull String mTitle) {
     ...
     * @param mTitle title for the Tab.
     */
    public XXBottomNavigationItem(Drawable mIcon, @NonNull String mTitle) {
        this.mIcon = mIcon;
        this.mTitle = mTitle;
    }
     ...
     */
    public XXBottomNavigationItem(Drawable mIcon, @StringRes int mTitleResource) {
        this.mIcon = mIcon;
     ...
     * @param mTitleResource resource for the title.
     */
    public XXBottomNavigationItem(@DrawableRes int mIconResource, @StringRes int mTitleResource) {
        this.mIconResource = mIconResource;
        this.mTitleResource = mTitleResource;
    }
     ...
     */
    public XXBottomNavigationItem setInactiveIcon(Drawable mInactiveIcon) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setInactiveIconResource(@DrawableRes int mInactiveIconResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setActiveColorResource(@ColorRes int colorResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setActiveColor(@Nullable String colorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setActiveColor(int color) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setInActiveColorResource(@ColorRes int colorResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setInActiveColor(@Nullable String colorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setInActiveColor(int color) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setBadgeItem(@Nullable XXShapeBadgeItem badgeItem) {
     ...
     * @return this, to allow builder pattern
     */
    public XXBottomNavigationItem setBadgeItem(@Nullable XXTextBadgeItem badgeItem) {
        this.mBadgeItem = badgeItem;
        return this;
    }
