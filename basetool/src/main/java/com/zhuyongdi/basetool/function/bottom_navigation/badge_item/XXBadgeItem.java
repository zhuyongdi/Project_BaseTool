...
public abstract class XXBadgeItem<T extends XXBadgeItem<T>> {
     ...
     */
    abstract void bindToBottomTabInternal(XXBottomNavigationTab bottomNavigationTab);
     ...
     * @param bottomNavigationTab to which badgeItem needs to be attached
     */
    public void bindToBottomTab(XXBottomNavigationTab bottomNavigationTab) {
     ...
     * @return this, to allow builder pattern
     */
    private T setTextView(XXBadgeTextView mTextView) {
     ...
     */
    WeakReference<XXBadgeTextView> getTextView() {
        return mTextViewRef;
    }
