...
public class XXBadgeTextView extends AppCompatTextView {

    private XXShapeBadgeItem mShapeBadgeItem;

    private boolean mAreDimensOverridden;
    private int mDesiredWidth = 100;
    private int mDesiredHeight = 100;

    public XXBadgeTextView(Context context) {
        this(context, null);
    }

    public XXBadgeTextView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXBadgeTextView(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     */
    public void setShapeBadgeItem(XXShapeBadgeItem shapeBadgeItem) {
