...
public class XXTextBadgeItem extends XXBadgeItem<XXTextBadgeItem> {
     ...
     */
    public XXTextBadgeItem setBackgroundColorResource(@ColorRes int colorResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setBackgroundColor(@Nullable String colorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setBackgroundColor(int color) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setTextColorResource(@ColorRes int colorResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setTextColor(@Nullable String colorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setTextColor(int color) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setText(@Nullable CharSequence text) {
        this.mText = text;
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setBorderColorResource(@ColorRes int colorResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setBorderColor(@Nullable String colorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setBorderColor(int color) {
     ...
     * @return this, to allow builder pattern
     */
    public XXTextBadgeItem setBorderWidth(int borderWidthInPixels) {
     ...
     */
    @Override
    XXTextBadgeItem getSubInstance() {
        return this;
    }
    ...
    private GradientDrawable getBadgeDrawable(Context context) {
        ...
        shape.setCornerRadius(context.getResources().getDimensionPixelSize(R.dimen.xx_badge_corner_radius));
