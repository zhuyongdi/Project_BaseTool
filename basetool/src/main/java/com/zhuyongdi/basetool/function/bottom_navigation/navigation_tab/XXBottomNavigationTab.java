...
public abstract class XXBottomNavigationTab extends FrameLayout {
    ...
    public XXBottomNavigationTab(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXBottomNavigationTab(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public XXBottomNavigationTab(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void setBadgeItem(XXBadgeItem badgeItem) {
