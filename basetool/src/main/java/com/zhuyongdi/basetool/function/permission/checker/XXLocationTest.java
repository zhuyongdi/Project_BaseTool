 ...
 */
class XXLocationTest implements XXPermissionTest {

    private LocationManager mManager;

    XXLocationTest(Context context) {
        this.mManager = (LocationManager) context.getSystemService(Context.LOCATION_SERVICE);
    }

    @RequiresPermission(anyOf = {XXPermission.ACCESS_FINE_LOCATION, XXPermission.ACCESS_COARSE_LOCATION})
    @Override
