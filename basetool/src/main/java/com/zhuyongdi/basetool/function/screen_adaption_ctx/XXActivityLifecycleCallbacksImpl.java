...
/**
 * ================================================
 * {@link XXActivityLifecycleCallbacksImpl} 可用来代替在 BaseActivity 中加入适配代码的传统方式
 * {@link XXActivityLifecycleCallbacksImpl} 这种方案类似于 AOP, 面向接口, 侵入性低, 方便统一管理, 扩展性强, 并且也支持适配三方库的 {@link Activity}
 * <p>
...
public class XXActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public XXActivityLifecycleCallbacksImpl(XXAutoAdaptStrategy autoAdaptStrategy) {
        mFragmentLifecycleCallbacks = new XXFragmentLifecycleCallbacksImpl(autoAdaptStrategy);
        mAutoAdaptStrategy = autoAdaptStrategy;
    }

    @Override
    public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
        if (XXAutoSizeConfig.getInstance().isCustomFragment()) {
     ...
     */
    public void setAutoAdaptStrategy(XXAutoAdaptStrategy autoAdaptStrategy) {
        mAutoAdaptStrategy = autoAdaptStrategy;
