 ...
 * 自定义 {@link View} 都会达到适配的效果, 如果某个页面不想使用适配请让该 {@link Activity} 实现 {@link XXCancelAdapt}
 * <p>
...
public final class XXAutoSize {
    ...
    public static void autoConvertDensityOfGlobal(Activity activity) {
        if (XXAutoSizeConfig.getInstance().isBaseOnWidth()) {
            autoConvertDensityBaseOnWidth(activity, XXAutoSizeConfig.getInstance().getDesignWidthInDp());
        } else {
            autoConvertDensityBaseOnHeight(activity, XXAutoSizeConfig.getInstance().getDesignHeightInDp());
        }
    }
     ...
     */
    public static void autoConvertDensityOfCustomAdapt(Activity activity, XXCustomAdapt customAdapt) {
     ...
     */
    public static void autoConvertDensityOfExternalAdaptInfo(Activity activity, XXExternalAdaptInfo externalAdaptInfo) {
    ...
    public static void autoConvertDensity(Activity activity, float sizeInDp, boolean isBaseOnWidth) {
        XXPreconditions.checkNotNull(activity, "activity == null");
    ...
    public static void cancelAdapt(Activity activity) {
        ...
        setDensity(activity, XXAutoSizeConfig.getInstance().getInitDensity()
