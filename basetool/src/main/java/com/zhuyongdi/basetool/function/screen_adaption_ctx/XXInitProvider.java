 ...
 * ================================================
 */
public class XXInitProvider extends ContentProvider {

    /**
     * 是否启用该屏幕适配,默认不自动启动
     * 如果需要启动请在{@link Application#attachBaseContext(Context)}的
     * super之前调用{@link XXInitProvider#AUTO_INIT}true
     */
