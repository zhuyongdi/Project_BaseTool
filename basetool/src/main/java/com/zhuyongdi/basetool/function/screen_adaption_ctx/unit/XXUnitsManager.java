...
public class XXUnitsManager {
     ...
     * 所以当项目中同时存在副单位和主单位, 并且副单位的设计图尺寸与主单位的设计图尺寸不同时, 就需要在 {@link XXUnitsManager} 中保存副单位的设计图尺寸
     */
     ...
     * @return {@link XXUnitsManager}
     * @see #mDesignWidth 详情请查看这个字段的注释
     * @see #mDesignHeight 详情请查看这个字段的注释
     */
    public XXUnitsManager setDesignSize(float designWidth, float designHeight) {
     ...
     * @see #mDesignWidth 详情请查看这个字段的注释
     */
    public XXUnitsManager setDesignWidth(float designWidth) {
        XXPreconditions.checkArgument(designWidth > 0, "designWidth must be > 0");
     ...
     * @see #mDesignHeight 详情请查看这个字段的注释
     */
    public XXUnitsManager setDesignHeight(float designHeight) {
        XXPreconditions.checkArgument(designHeight > 0, "designHeight must be > 0");
        mDesignHeight = designHeight;
        return this;
    }

    /**
     * 是否支持 dp 单位, 默认支持, 详情请看类文件的注释 {@link XXUnitsManager}
     *
    ...
    /**
     * 是否让 AndroidAutoSize 支持 dp 单位, 默认支持, 详情请看类文件的注释 {@link XXUnitsManager}
     *
     * @param supportDP {@code true} 为支持, {@code false} 为不支持
     */
    public XXUnitsManager setSupportDP(boolean supportDP) {
        isSupportDP = supportDP;
        return this;
    }

    /**
     * 是否支持 sp 单位, 默认支持, 详情请看类文件的注释 {@link XXUnitsManager}
     *
     * @return {@code true} 为支持, {@code false} 为不支持
     */
    ...
    /**
     * 是否让 AndroidAutoSize 支持 sp 单位, 默认支持, 详情请看类文件的注释 {@link XXUnitsManager}
     *
     * @param supportSP {@code true} 为支持, {@code false} 为不支持
     */
    public XXUnitsManager setSupportSP(boolean supportSP) {
        isSupportSP = supportSP;
        return this;
    }

    /**
     * AndroidAutoSize 以什么单位为副单位, 默认为 {@link XXSubunits#NONE}, 即不支持副单位, 详情请看类文件的注释 {@link XXUnitsManager}
     *
     * @return {@link XXSubunits}
     */
     ...
     * 默认为 {@link XXSubunits#NONE}, 即不支持副单位, 详情请看类文件的注释 {@link XXUnitsManager}
     *
     * @param supportSubunits {@link XXSubunits}
     */
    public XXUnitsManager setSupportSubunits(XXSubunits supportSubunits) {
        mSupportSubunits = XXPreconditions.checkNotNull(supportSubunits,
