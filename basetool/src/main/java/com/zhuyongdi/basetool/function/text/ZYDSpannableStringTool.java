...
public class ZYDSpannableStringTool {

    private SpannableString spannableString;
    private String str;

    private ZYDSpannableStringTool(String str) {
        this.str = str;
        spannableString = new SpannableString(str);
    }

    public static ZYDSpannableStringTool getInstance(String str) {
        return new ZYDSpannableStringTool(str);
    }

    /**
     * 设置字体颜色
     */
    public ZYDSpannableStringTool color(int color, int start, int end) {
     ...
     * 设置字体颜色
     */
    public ZYDSpannableStringTool color(int color, String part) {
     ...
     * 设置字体背景色
     */
    public ZYDSpannableStringTool color_background(int color, int start, int end) {
     ...
     * 设置字体大小
     */
    public ZYDSpannableStringTool size(int textSize, int start, int end) {
     ...
     * 设置字体为上标
     */
    public ZYDSpannableStringTool superscript(int start, int end) {
     ...
     * 设置字体为下标
     */
    public ZYDSpannableStringTool subscript(int start, int end) {
     ...
     * 添加图片到某个位置
     */
    public ZYDSpannableStringTool addImg(int offset, Drawable drawable, int drawableSize) {
     ...
     * 替换字体为图片
     */
    public ZYDSpannableStringTool replaceImg(int start, int end, Drawable drawable, int drawableSize) {
     ...
     * 设置字体风格
     */
    public ZYDSpannableStringTool style(int style, int start, int end) {
     ...
     * 设置删除线
     */
    public ZYDSpannableStringTool strikethrough(int start, int end) {
     ...
     * 设置下划线
     */
    public ZYDSpannableStringTool underline(int start, int end) {
     ...
     */
    public ZYDSpannableStringTool onClick(int start, int end, OnTextClickListener onTextClickListener, boolean isShowUnderline) {
     ...
     * TextView需要设置TextView.setMovementMethod(LinkMovementMethod.getInstance())才会生效
     */
    public ZYDSpannableStringTool onURL(int start, int end, String url) {
