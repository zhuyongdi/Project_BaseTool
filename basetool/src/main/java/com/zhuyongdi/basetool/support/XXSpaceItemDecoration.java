...
public class XXSpaceItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public XXSpaceItemDecoration(int leftRight, int topBottom, int headItemCount, @LayoutManager int layoutManager) {
     ...
     * GridLayoutManager or StaggeredGridLayoutManager spacing
     */
    public XXSpaceItemDecoration(int space, boolean includeEdge, @LayoutManager int layoutManager) {
     ...
     * GridLayoutManager or StaggeredGridLayoutManager spacing
     */
    public XXSpaceItemDecoration(int space, int headItemCount, boolean includeEdge, @LayoutManager int layoutManager) {
        this.space = space;
        this.headItemCount = headItemCount;
     ...
     * GridLayoutManager or StaggeredGridLayoutManager spacing
     */
    public XXSpaceItemDecoration(int space, int headItemCount, @LayoutManager int layoutManager) {
     ...
     */
    public XXSpaceItemDecoration(int space, @LayoutManager int layoutManager) {
