...
public class XXBitmapBlurUtil {
    ...
    public static Bitmap addGaussBlurByFastBlur(Bitmap bitmap, int radius) {
        return bitmap == null ? null : XXFastBlurTransformation.transfer(bitmap, radius, true);
    }
    ...
    public static Bitmap addGaussBlurByRSBlur(Context context, Bitmap bitmap, int radius) {
        return bitmap == null ? null : XXRSBlurTransformation.transfer(context, bitmap, radius);
    }
