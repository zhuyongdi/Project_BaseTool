...
public class KeyboardHeightProvider extends PopupWindow {
     ...
     */
    public KeyboardHeightProvider(Activity activity, boolean isSetImmersiveStatusBar) {
        super(activity);
        this.activity = activity;
        this.immersiveStatusBarHeight = isSetImmersiveStatusBar ? ScreenTool.getImmersiveStatusBarHeight(activity) : 0;
        this.COMPARE = dp2px(activity, 200);

        LayoutInflater inflater = (LayoutInflater) activity.getSystemService(Activity.LAYOUT_INFLATER_SERVICE);
        this.popupView = inflater.inflate(R.layout.popupwindow_keyboard, null, false);
