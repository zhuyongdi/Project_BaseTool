...
public class XXIDCardValidateUtil {
    ...
    public static boolean isIDCardSimple(String input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_ID_CARD15, input) || XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_ID_CARD18, input);
    }
    ...
    public static boolean isIDCardExact(String input) {
        ...
        try {
            ...
            if (XXNumberValidateUtil.isNumber(iDCardNo)) {
                return false;
            }
            //判断出生年月
            ...
            if (XXDateValidateUtil.isDate(strYear + "-" + strMonth + "-" + strDay)) {
                return false;
            }
            ...
            //判断地区码
            Hashtable h = XXChinaAreaIDCode.AREA_CODE_TABLE;
