...
public class XXNumberValidateUtil {
    ...
    public static boolean isNumber(String input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_NUMBER, input);
    }
    ...
    public static boolean isZero(CharSequence input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_ZERO, input);
    }
    ...
    public static boolean isIntegerPositive(CharSequence input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_INTEGER_POSITIVE, input);
    }
    ...
    public static boolean isIntegerNegative(CharSequence input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_INTEGER_NEGATIVE, input);
    }
    ...
    public static boolean isFloatPositive(CharSequence input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_FLOAT_POSITIVE, input);
    }
    ...
    public static boolean isFloatNegative(CharSequence input) {
        return XXPatternMatcher.isMatchByRegEx(XXCommonRegEx.REGEX_FLOAT_NEGATIVE, input);
    }
