 ...
 */
public class XXRoundedCornersTransformation {
    ...
    public XXRoundedCornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public XXRoundedCornersTransformation(Context context, int radius, int margin, CornerType cornerType) {
        mRadius = radius;
        mDiameter = mRadius * 2;
        mMargin = margin;
