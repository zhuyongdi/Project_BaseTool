...
public class XXCommonIndicator extends View {
    ...
    public XXCommonIndicator(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXCommonIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.XXCommonIndicator);
        mSelectColor = ta.getColor(R.styleable.XXCommonIndicator_xx_common_indicator_select_color, 0xFF666666);
        mUnSelectColor = ta.getColor(R.styleable.XXCommonIndicator_xx_common_indicator_unselect_color, 0xFF999999);
        mSelectWidth = ta.getDimensionPixelSize(R.styleable.XXCommonIndicator_xx_common_indicator_select_width, 50);
        mUnSelectWidth = ta.getDimensionPixelSize(R.styleable.XXCommonIndicator_xx_common_indicator_unselect_width, 40);
        mPadding = ta.getDimensionPixelSize(R.styleable.XXCommonIndicator_xx_common_indicator_padding, 80);
        mSize = ta.getInteger(R.styleable.XXCommonIndicator_xx_common_indicator_size, 0);
        ta.recycle();
    }
