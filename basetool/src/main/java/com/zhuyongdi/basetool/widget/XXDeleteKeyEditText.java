...
public class XXDeleteKeyEditText extends EditText {

    private OnDeleteKeyListener deleteKeyListener;

    public XXDeleteKeyEditText(Context context) {
        super(context);
    }

    public XXDeleteKeyEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public XXDeleteKeyEditText(Context context, AttributeSet attrs, int defStyle) {
