...
public class XXMailBoxAutoCompleteTextView extends MultiAutoCompleteTextView {
    ...
    public XXMailBoxAutoCompleteTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public XXMailBoxAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
