...
public class XXBubbleLinearLayout extends LinearLayout {
    ...
    public XXBubbleLinearLayout(Context context) {
        this(context, null);
    }

    public XXBubbleLinearLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXBubbleLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
