...
public class XXBubbleListView extends ListView{
    ...
    public XXBubbleListView(Context context) {
        this(context, null);
    }

    public XXBubbleListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXBubbleListView(Context context, AttributeSet attrs, int defStyleAttr) {
