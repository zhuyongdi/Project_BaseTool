...
public class XXBubbleRecyclerView extends RecyclerView {
    ...
    public XXBubbleRecyclerView(Context context) {
        this(context, null);
    }

    public XXBubbleRecyclerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXBubbleRecyclerView(Context context, AttributeSet attrs, int defStyleAttr) {
