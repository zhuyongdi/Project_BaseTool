...
import static com.zhuyongdi.basetool.widget.card_view.XXRoundRectDrawableWithShadow.calculateHorizontalPadding;
import static com.zhuyongdi.basetool.widget.card_view.XXRoundRectDrawableWithShadow.calculateVerticalPadding;

@RequiresApi(21)
class XXRoundRectDrawable extends Drawable {
    ...
    XXRoundRectDrawable(ColorStateList backgroundColor, float radius) {
        mRadius = radius;
