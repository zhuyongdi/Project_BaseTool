...
class XXRoundRectDrawableWithShadow extends Drawable {
    ...
    XXRoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
                                  float shadowSize, float maxShadowSize) {
        mShadowStartColor = resources.getColor(R.color.xx_card_view_shadow_start_color);
        mShadowEndColor = resources.getColor(R.color.xx_card_view_shadow_end_color);
        mInsetShadow = resources.getDimensionPixelSize(R.dimen.xx_card_view_compat_inset_shadow);
