...
package com.zhuyongdi.basetool.widget.card_view.l;
 ...
 */
public class XXCardLinearLayout extends LinearLayout {
    ...
    public XXCardLinearLayout(@NonNull Context context) {
        this(context, null);
    }

    public XXCardLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.XXCardViewStyle);
    }

    public XXCardLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final XXCardViewDelegate mCardViewDelegate = new XXCardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return XXCardLinearLayout.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return XXCardLinearLayout.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            XXCardLinearLayout.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                XXCardLinearLayout.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                XXCardLinearLayout.super.setMinimumHeight(height);
            }
        }
        ...
        public View getCardView() {
            return XXCardLinearLayout.this;
        }
    };
}
