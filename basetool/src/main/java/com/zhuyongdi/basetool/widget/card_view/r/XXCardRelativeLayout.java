package com.zhuyongdi.basetool.widget.card_view.r;
...
public class XXCardRelativeLayout extends RelativeLayout {
    ...
    public XXCardRelativeLayout(@NonNull Context context) {
        this(context, null);
    }

    public XXCardRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.XXCardViewStyle);
    }

    public XXCardRelativeLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private final XXCardViewDelegate mCardViewDelegate = new XXCardViewDelegate() {
        ...
        @Override
        public boolean getUseCompatPadding() {
            return XXCardRelativeLayout.this.getUseCompatPadding();
        }

        @Override
        public boolean getPreventCornerOverlap() {
            return XXCardRelativeLayout.this.getPreventCornerOverlap();
        }

        @Override
        public void setShadowPadding(int left, int top, int right, int bottom) {
            mShadowBounds.set(left, top, right, bottom);
            XXCardRelativeLayout.super.setPadding(left + mContentPadding.left, top + mContentPadding.top,
        ...
        public void setMinWidthHeightInternal(int width, int height) {
            if (width > mUserSetMinWidth) {
                XXCardRelativeLayout.super.setMinimumWidth(width);
            }
            if (height > mUserSetMinHeight) {
                XXCardRelativeLayout.super.setMinimumHeight(height);
            }
        }
        ...
        public View getCardView() {
            return XXCardRelativeLayout.this;
        }
    };
