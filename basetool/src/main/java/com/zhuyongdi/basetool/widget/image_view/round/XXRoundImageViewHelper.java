 ...
 * @author ZhongDaFeng
 */
public class XXRoundImageViewHelper {
    ...
    public XXRoundImageViewHelper(Context context, ImageView view, AttributeSet attrs) {
        mView = view;
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XXRoundImageView);
        //icon
        //Vector兼容处理
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            mIconNormal = a.getDrawable(R.styleable.XXRoundImageView_xx_round_image_view_icon_src_normal);
            mIconPressed = a.getDrawable(R.styleable.XXRoundImageView_xx_round_image_view_icon_src_pressed);
            mIconUnable = a.getDrawable(R.styleable.XXRoundImageView_xx_round_image_view_icon_src_unable);
        } else {
            int normalId = a.getResourceId(R.styleable.XXRoundImageView_xx_round_image_view_icon_src_normal, -1);
            int pressedId = a.getResourceId(R.styleable.XXRoundImageView_xx_round_image_view_icon_src_pressed, -1);
            int unableId = a.getResourceId(R.styleable.XXRoundImageView_xx_round_image_view_icon_src_unable, -1);
        ...
        //基础属性
        mIsCircle = a.getBoolean(R.styleable.XXRoundImageView_xx_round_image_view_is_circle, false);
        mCorner = a.getDimensionPixelSize(R.styleable.XXRoundImageView_xx_round_image_view_corner_radius, -1);
        mCornerTopLeft = a.getDimensionPixelSize(R.styleable.XXRoundImageView_xx_round_image_view_corner_radius_top_left, 0);
        mCornerTopRight = a.getDimensionPixelSize(R.styleable.XXRoundImageView_xx_round_image_view_corner_radius_top_right, 0);
        mCornerBottomLeft = a.getDimensionPixelSize(R.styleable.XXRoundImageView_xx_round_image_view_corner_radius_bottom_left, 0);
        mCornerBottomRight = a.getDimensionPixelSize(R.styleable.XXRoundImageView_xx_round_image_view_corner_radius_bottom_right, 0);
        mBorderWidth = a.getDimensionPixelSize(R.styleable.XXRoundImageView_xx_round_image_view_border_width, 0);
        mBorderColor = a.getColor(R.styleable.XXRoundImageView_xx_round_image_view_border_color, Color.BLACK);
    ...
    public XXRoundImageViewHelper setIconNormal(Drawable icon) {
    ...
    public XXRoundImageViewHelper setIconPressed(Drawable icon) {
    ...
    public XXRoundImageViewHelper setIconUnable(Drawable icon) {
    ...
    public XXRoundImageViewHelper setBorderWidth(int borderWidth) {
    ...
    public XXRoundImageViewHelper setBorderColor(@ColorInt int borderColor) {
    ...
    public XXRoundImageViewHelper setCorner(float corner) {
        this.mCorner = corner;
        init();
        invalidate();
        return this;
    ...
    public XXRoundImageViewHelper setCornerTopLeft(float cornerTopLeft) {
        this.mCorner = -1;
    ...
    public XXRoundImageViewHelper setCornerTopRight(float cornerTopRight) {
        this.mCorner = -1;
    ...
    public XXRoundImageViewHelper setCornerBottomLeft(float cornerBottomLeft) {
        this.mCorner = -1;
    ...
    public XXRoundImageViewHelper setCornerBottomRight(float cornerBottomRight) {
        this.mCorner = -1;
    ...
    public XXRoundImageViewHelper setCorner(float topLeft, float topRight, float bottomRight, float bottomLeft) {
        this.mCorner = -1;
