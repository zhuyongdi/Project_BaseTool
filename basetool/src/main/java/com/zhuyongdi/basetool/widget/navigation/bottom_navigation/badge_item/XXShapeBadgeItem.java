 ...
 * Class description
 */
public class XXShapeBadgeItem extends XXBadgeItem<XXShapeBadgeItem> {
...
//            paint.setStyle(Paint.Style.STROKE);
     ...
     */
    public XXShapeBadgeItem setShape(@Shape int shape) {
        this.mShape = shape;
        refreshDraw();
        return this;
    }
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setShapeColorResource(@ColorRes int colorResource) {
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setShapeColor(@Nullable String colorCode) {
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setShapeColor(int color) {
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setSizeInDp(Context context, int heightInDp, int widthInDp) {
        mHeightInPixels = XXPixelUtil.dp2px(context, heightInDp);
        mWidthInPixels = XXPixelUtil.dp2px(context, widthInDp);
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setSizeInPixels(int heightInPx, int widthInPx) {
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setEdgeMarginInDp(Context context, int edgeMarginInDp) {
        mEdgeMarginInPx = XXPixelUtil.dp2px(context, edgeMarginInDp);
        refreshMargin();
        return this;
    }
     ...
     * @return this, to allow builder pattern
     */
    public XXShapeBadgeItem setEdgeMarginInPixels(int edgeMarginInPx) {
     ...
     */
    @Override
    XXShapeBadgeItem getSubInstance() {
        return this;
    }
     ...
     */
    @Override
    void bindToBottomTabInternal(XXBottomNavigationTab bottomNavigationTab) {
        if (mHeightInPixels == 0)
            mHeightInPixels = XXPixelUtil.dp2px(bottomNavigationTab.getContext(), 12);
        if (mWidthInPixels == 0)
            mWidthInPixels = XXPixelUtil.dp2px(bottomNavigationTab.getContext(), 12);
        if (mEdgeMarginInPx == 0)
            mEdgeMarginInPx = XXPixelUtil.dp2px(bottomNavigationTab.getContext(), 4);
