 ...
 * @since 06 Jun 2016
 */
public class XXBottomNavBarFabBehaviour extends CoordinatorLayout.Behavior<FloatingActionButton> {
...
//    }
    ...
    private boolean isDependent(View dependency) {
        return dependency instanceof XXBottomNavigationBar || dependency instanceof Snackbar.SnackbarLayout;
    }
...
//        }
    ...
    private float[] getFabTranslationYForBottomNavigationBar(CoordinatorLayout parent,
        ...
        for (int i = 0, z = dependencies.size(); i < z; i++) {
            ...
            if (view instanceof XXBottomNavigationBar) {
