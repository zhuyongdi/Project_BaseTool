 ...
 * Class description
 */
public class XXBottomVerticalScrollBehavior<V extends View> extends XXVerticalScrollingBehavior<V> {
    private static final Interpolator INTERPOLATOR = new FastOutSlowInInterpolator();
    private int mBottomNavHeight;
    private WeakReference<XXBottomNavigationBar> mViewRef;
    ...
    public boolean onLayoutChild(CoordinatorLayout parent, final V child, int layoutDirection) {
        ...
        if (child instanceof XXBottomNavigationBar) {
            mViewRef = new WeakReference<>((XXBottomNavigationBar) child);
        }
...
//        }
    ...
    private void handleDirection(CoordinatorLayout parent, V child, int scrollDirection) {
        XXBottomNavigationBar bottomNavigationBar = mViewRef.get();
