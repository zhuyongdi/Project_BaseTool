 ...
 * @since 25 Mar 2016
 */
public abstract class XXVerticalScrollingBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public XXVerticalScrollingBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public XXVerticalScrollingBehavior() {
        super();
    }
