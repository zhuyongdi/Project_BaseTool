package com.zhuyongdi.basetool.widget.navigation.top_navigation;
...
public class XXTabLayout extends HorizontalScrollView {
    ...
    public interface OnTabSelectedListener {
         ...
         */
        public void onTabSelected(XXTabLayout.Tab tab);
         ...
         */
        public void onTabUnselected(XXTabLayout.Tab tab);
         ...
         */
        public void onTabReselected(XXTabLayout.Tab tab);
    }

    private final ArrayList<Tab> mTabs = new ArrayList<>();
    private XXTabLayout.Tab mSelectedTab;

    private final XXTabLayout.SlidingTabStrip mTabStrip;
    ...
    private XXTabLayout.OnTabSelectedListener mOnTabSelectedListener;
    ...
    private XXTabLayout.TabLayoutOnPageChangeListener mPageChangeListener;

    // Pool we use as a simple RecyclerBin
    private final Pools.Pool<TabView> mTabViewPool = new Pools.SimplePool<>(12);

    public XXTabLayout(Context context) {
        this(context, null);
    }

    public XXTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        // Add the TabStrip
        mTabStrip = new XXTabLayout.SlidingTabStrip(context);
   ...
   /*     TypedArray a = context.obtainStyledAttributes(attrs, android.support.design.R.styleable.TabLayout,
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.XXTabLayout,
                defStyleAttr, android.support.design.R.style.Widget_Design_TabLayout);

        mTabStrip.setSelectedIndicatorHeight(
                a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_indicator_height, dpToPx(2)));
        mTabStrip.setmSelectedIndicatorWidth(
                a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_indicator_width, 0));
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.XXTabLayout_xx_tab_layout_indicator_color, 0));

        mTabPaddingStart = mTabPaddingTop = mTabPaddingEnd = mTabPaddingBottom = a
                .getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_padding, 0);
        mTabPaddingStart = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_padding_start,
                mTabPaddingStart);
        mTabPaddingTop = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_padding_top,
                mTabPaddingTop);
        mTabPaddingEnd = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_padding_end,
                mTabPaddingEnd);
        mTabPaddingBottom = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_padding_bottom,
                mTabPaddingBottom);

        xTabTextAllCaps = a.getBoolean(R.styleable.XXTabLayout_xx_tab_layout_text_all_caps, false);

        mTabTextAppearance = a.getResourceId(R.styleable.XXTabLayout_xx_tab_layout_text_appearance,
                android.support.design.R.style.TextAppearance_Design_Tab);
        mTabTextSize = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_text_size, 0);
        xTabTextBold = a.getBoolean(R.styleable.XXTabLayout_xx_tab_layout_text_bold, false);
        mTabSelectedTextSize = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_selected_text_size, 0);
        xTabTextSelectedBold = a.getBoolean(R.styleable.XXTabLayout_xx_tab_layout_selected_text_bold, false);
        ...
        if (a.hasValue(R.styleable.XXTabLayout_xx_tab_layout_text_color)) {
            // If we have an explicit text color set, use it instead
            mTabTextColors = a.getColorStateList(R.styleable.XXTabLayout_xx_tab_layout_text_color);
        }

        if (a.hasValue(R.styleable.XXTabLayout_xx_tab_layout_selected_text_color)) {
            // We have an explicit selected text color set, so we need to make merge it with the
            // current colors. This is exposed so that developers can use theme attributes to set
            // this (theme attrs in ColorStateLists are Lollipop+)
            final int selected = a.getColor(R.styleable.XXTabLayout_xx_tab_layout_selected_text_color, 0);
            mTabTextColors = createColorStateList(mTabTextColors.getDefaultColor(), selected);
        }

        xTabDisplayNum = a.getInt(R.styleable.XXTabLayout_xx_tab_layout_display_num, 0);
        mRequestedTabMinWidth = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_min_width,
                INVALID_WIDTH);
        mRequestedTabMaxWidth = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_max_width,
                INVALID_WIDTH);
        xTabBackgroundColor = a.getColor(R.styleable.XXTabLayout_xx_tab_background_color, 0);
        xTabSelectedBackgroundColor = a.getColor(R.styleable.XXTabLayout_xx_tab_selected_background_color, 0);

        mContentInsetStart = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_content_start, 0);
        mMode = a.getInt(R.styleable.XXTabLayout_xx_tab_layout_mode, MODE_FIXED);
        mTabGravity = a.getInt(R.styleable.XXTabLayout_xx_tab_layout_gravity, GRAVITY_FILL);

        dividerWidth = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_divider_width, 0);
        dividerHeight = a.getDimensionPixelSize(R.styleable.XXTabLayout_xx_tab_layout_divider_height, 0);
        dividerColor = a.getColor(R.styleable.XXTabLayout_xx_tab_layout_divider_color, Color.BLACK);
        dividerGravity = a.getInteger(R.styleable.XXTabLayout_xx_tab_layout_divider_gravity, DividerDrawable.CENTER);

        xTabDividerWidthWidthText = a.getBoolean(R.styleable.XXTabLayout_xx_tab_layout_divider_width_changed_with_text, false);
...
//        invalidate();
     ...
     */
    public void addTab(@NonNull XXTabLayout.Tab tab) {
     ...
     */
    public void addTab(@NonNull XXTabLayout.Tab tab, int position) {
     ...
     */
    public void addTab(@NonNull XXTabLayout.Tab tab, boolean setSelected) {
        if (tab.mParent != this) {
     ...
     * @param setSelected True if the added tab should become the selected tab.
     */
    public void addTab(@NonNull XXTabLayout.Tab tab, int position, boolean setSelected) {
        if (tab.mParent != this) {
            throw new IllegalArgumentException("Tab belongs to a different TabLayout.");
        }
    ...
    private void addTabFromItemView(@NonNull TabItem item) {
        final XXTabLayout.Tab tab = newTab();
        if (item.mText != null) {
     ...
     */
    public void setOnTabSelectedListener(XXTabLayout.OnTabSelectedListener onTabSelectedListener) {
        mOnTabSelectedListener = onTabSelectedListener;
    }

    @NonNull
    public XXTabLayout.Tab newTab() {
        XXTabLayout.Tab tab = sTabPool.acquire();
        if (tab == null) {
            tab = new XXTabLayout.Tab();
        }
        tab.mParent = this;
     ...
     */
    @Nullable
    public XXTabLayout.Tab getTabAt(int index) {
     ...
     */
    public void removeTab(XXTabLayout.Tab tab) {
        if (tab.mParent != this) {
    ...
    public void removeTabAt(int position) {
        ...
        final XXTabLayout.Tab removedTab = mTabs.remove(position);
        if (removedTab != null) {
            removedTab.reset();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<Tab> i = mTabs.iterator(); i.hasNext(); ) {
            final XXTabLayout.Tab tab = i.next();
            i.remove();
            tab.reset();
    ...
    public void setupWithViewPager(@Nullable final ViewPager viewPager) {
        ...
        if (viewPager != null) {
            ...
            if (mPageChangeListener == null) {
                mPageChangeListener = new XXTabLayout.TabLayoutOnPageChangeListener(this);
            }
            mPageChangeListener.reset();
            viewPager.addOnPageChangeListener(mPageChangeListener);

            // Now we'll add a tab selected listener to set ViewPager's current item
            setOnTabSelectedListener(new XXTabLayout.ViewPagerOnTabSelectedListener(viewPager));
    ...
    private void setPagerAdapter(@Nullable final PagerAdapter adapter, final boolean addObserver) {
        ...
        if (addObserver && adapter != null) {
            ...
            if (mPagerAdapterObserver == null) {
                mPagerAdapterObserver = new XXTabLayout.PagerAdapterObserver();
            }
    ...
    private XXTabLayout.TabView createTabView(@NonNull final XXTabLayout.Tab tab) {
        XXTabLayout.TabView tabView = mTabViewPool != null ? mTabViewPool.acquire() : null;
        if (tabView == null) {
            tabView = new XXTabLayout.TabView(getContext());
        }
        tabView.setTab(tab);
    ...
    private void configureTab(XXTabLayout.Tab tab, int position) {
    ...
    private void addTabView(XXTabLayout.Tab tab, boolean setSelected) {
        final XXTabLayout.TabView tabView = tab.mView;
    ...
    private void addTabView(XXTabLayout.Tab tab, int position, boolean setSelected) {
        final XXTabLayout.TabView tabView = tab.mView;
    ...
    private void removeTabViewAt(int position) {
        final XXTabLayout.TabView view = (XXTabLayout.TabView) mTabStrip.getChildAt(position);
    ...
    private void animateToTab(int newPosition) {
        if (newPosition == XXTabLayout.Tab.INVALID_POSITION) {
            return;
        }
    ...
    void selectTab(XXTabLayout.Tab tab) {
        selectTab(tab, true);
    }

    void selectTab(XXTabLayout.Tab tab, boolean updateIndicator) {
        if (mSelectedTab == tab) {
            ...
            if (updateIndicator) {
                final int newPosition = tab != null ? tab.getPosition() : XXTabLayout.Tab.INVALID_POSITION;
                if (newPosition != XXTabLayout.Tab.INVALID_POSITION) {
                    setSelectedTabView(newPosition);
                }
                if ((mSelectedTab == null || mSelectedTab.getPosition() == XXTabLayout.Tab.INVALID_POSITION)
                        && newPosition != XXTabLayout.Tab.INVALID_POSITION) {
    ...
    public static final class Tab {
        ...
        private XXTabLayout mParent;
        private XXTabLayout.TabView mView;
       ...
       /* private Tab() {
        ...
        public Tab(XXTabLayout parent, String text) {
            mParent = parent;
            mText = text;
        }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setTag(@Nullable Object tag) {
            mTag = tag;
            return this;
        }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setCustomView(@Nullable View view) {
            mCustomView = view;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setCustomView(@LayoutRes int resId) {
         ...
         */
        @NonNull
        public XXTabLayout.Tab setIcon(@Nullable Drawable icon) {
            mIcon = icon;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setIcon(@DrawableRes int resId) {
            if (mParent == null) {
         ...
         */
        @NonNull
        public XXTabLayout.Tab setText(@Nullable CharSequence text) {
            mText = text;
            updateView();
            return this;
        }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setText(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setContentDescription(@StringRes int resId) {
            if (mParent == null) {
                throw new IllegalArgumentException("Tab not attached to a TabLayout");
            }
         ...
         */
        @NonNull
        public XXTabLayout.Tab setContentDescription(@Nullable CharSequence contentDesc) {
...
//                        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, textSize);
        ...
        private void setTab(@Nullable final XXTabLayout.Tab tab) {
            if (tab != mTab) {
                mTab = tab;
                update();
            }
        ...
        final void update() {
            final XXTabLayout.Tab tab = mTab;
    ...
    private int getDefaultHeight() {
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            XXTabLayout.Tab tab = mTabs.get(i);
    ...
    public static class TabLayoutOnPageChangeListener implements ViewPager.OnPageChangeListener {
        private final WeakReference<XXTabLayout> mTabLayoutRef;
        private int mPreviousScrollState;
        private int mScrollState;

        public TabLayoutOnPageChangeListener(XXTabLayout tabLayout) {
        ...
        public void onPageScrolled(int position, float positionOffset,
            ...
            final XXTabLayout tabLayout = mTabLayoutRef.get();
            if (tabLayout != null) {
     ...
     */
    public static class ViewPagerOnTabSelectedListener implements XXTabLayout.OnTabSelectedListener {
