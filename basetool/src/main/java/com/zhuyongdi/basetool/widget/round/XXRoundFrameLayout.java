 ...
 * 作者：GcsSloop
 */
public class XXRoundFrameLayout extends FrameLayout implements Checkable, XXRoundAttrs {

    private XXRoundHelper mRoundHelper;

    public XXRoundFrameLayout(Context context) {
        this(context, null);
    }

    public XXRoundFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXRoundFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
