...
public class XXRoundHelper {
    ...
    public void initAttrs(Context context, AttributeSet attrs) {
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.XXRoundAttrs);
        mRoundAsCircle = ta.getBoolean(R.styleable.XXRoundAttrs_xx_round_is_circle, false);
        mStrokeColorStateList = ta.getColorStateList(R.styleable.XXRoundAttrs_xx_round_stroke_color);
        ...
        int roundCornerTopRight = ta.getDimensionPixelSize(
                R.styleable.XXRoundAttrs_xx_round_corner_top_right, roundCorner);
        int roundCornerBottomLeft = ta.getDimensionPixelSize(
                R.styleable.XXRoundAttrs_xx_round_corner_bottom_left, roundCorner);
        int roundCornerBottomRight = ta.getDimensionPixelSize(
                R.styleable.XXRoundAttrs_xx_round_corner_bottom_right, roundCorner);
        ta.recycle();
    ...
    public void drawableStateChanged(View view) {
        if (view instanceof XXRoundAttrs) {
            ...
            if (mStrokeColorStateList != null && mStrokeColorStateList.isStateful()) {
                ...
                ((XXRoundAttrs) view).setStrokeColor(stateColor);
            }
        }
    }
