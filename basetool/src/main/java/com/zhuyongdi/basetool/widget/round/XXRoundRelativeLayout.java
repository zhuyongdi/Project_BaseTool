 ...
 * 作者：GcsSloop
 */
public class XXRoundRelativeLayout extends RelativeLayout implements Checkable, XXRoundAttrs {

    private XXRoundHelper mRoundHelper;

    public XXRoundRelativeLayout(Context context) {
        this(context, null);
    }

    public XXRoundRelativeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XXRoundRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
