 ...
 * 作者：GcsSloop
 */
public class XXRoundViewPager extends ViewPager implements Checkable, XXRoundAttrs {

    private XXRoundHelper mRoundHelper;

    public XXRoundViewPager(Context context) {
        this(context, null);
    }

    public XXRoundViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
