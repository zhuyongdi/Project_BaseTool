...
public class XXSwipeMenuLayout extends FrameLayout {
    ...
    private XXSwipeMenuView mMenuView;
    private int mDownX;
    ...
    public XXSwipeMenuLayout(View contentView, XXSwipeMenuView menuView) {
    ...
    private XXSwipeMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    private XXSwipeMenuLayout(Context context) {
        super(context);
    }
    ...
    private void init() {
        ...
        MIN_FLING = XXPixelUtil.dp2px(getContext(), 15);
        MAX_VELOCITYX = -XXPixelUtil.dp2px(getContext(), 500);
    ...
    private void swipe(int dis) {
        ...
        if (mSwipeDirection == XXSwipeMenuListView.DIRECTION_LEFT) {
    ...
    public XXSwipeMenuView getMenuView() {
        return mMenuView;
    }
