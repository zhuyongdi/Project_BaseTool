 ...
 * @author baoyz
 */
public class XXSwipeMenuView extends LinearLayout implements OnClickListener {
    ...
    public XXSwipeMenuView(XXSwipeMenu menu, XXSwipeMenuListView listView) {
    ...
    public void setLayout(XXSwipeMenuLayout mLayout) {
        this.mLayout = mLayout;
    }

    public interface OnSwipeItemClickListener {
        void onItemClick(XXSwipeMenuView view, XXSwipeMenu menu, int index);
    }
}
