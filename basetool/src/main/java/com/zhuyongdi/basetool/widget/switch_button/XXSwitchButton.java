package com.zhuyongdi.basetool.widget.switch_button;
...
public class XXSwitchButton extends View implements Checkable {
    ...
    public XXSwitchButton(Context context) {
        super(context);
        init(context, null);
    }

    public XXSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public XXSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public XXSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.XXSwitchButton);
        }

        shadowEffect = optBoolean(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_shadow_effect,
                true);
        ...
        shadowRadius = optPixelSize(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_shadow_radius,
                dp2pxInt(2.5f));//dp2pxInt(2.5f);

        shadowOffset = optPixelSize(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_shadow_offset,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        shadowColor = optColor(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_shadow_color,
                0X33000000);//0X33000000;

        uncheckColor = optColor(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_uncheck_color,
                0XffDDDDDD);//0XffDDDDDD;

        checkedColor = optColor(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_checked_color,
                0Xff51d367);//0Xff51d367;

        borderWidth = optPixelSize(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_border_width,
        ...
        int buttonColor = optColor(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_button_color,
                Color.WHITE);//Color.WHITE;

        int effectDuration = optInt(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_effect_duration,
                300);//300;

        isChecked = optBoolean(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_checked,
                false);

        showIndicator = optBoolean(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_show_indicator,
                true);

        background = optColor(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_background,
                Color.WHITE);//Color.WHITE;

        enableEffect = optBoolean(typedArray,
                R.styleable.XXSwitchButton_xx_switch_button_enable_effect,
                true);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(XXSwitchButton view, boolean isChecked);
    }
